//
// Created by rcanovas on 02/11/16.
//

#ifndef CDSLIB_BHLZ78_H
#define CDSLIB_BHLZ78_H
...
namespace cdslib {
    ...
    public:
        ...
        size_type
        insert(size_type node_value, std::ostream& out, std::istream &in) {
    ...
    private:
        ...
        bhlz78(size_type _MAX_M, size_type _M, size_type _sigma,
        ...
        process_text(std::istream &in, std::ostream &out) {
            ...
            while (in.get(c)) {
                ...
                current_node_pos = insert(node_value, out, in);
            }
        ...
        void
        restart_structure(std::ostream &out, std::istream &in) {
            std::cout << "restarting structure  " << std::endl;
            delete [] buffer;
