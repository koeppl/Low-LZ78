...
namespace cdslib {
    ...
    public:
        ...
        compress_file(std::string file_name, std::string out_file, size_type s,
                      double t_factor = 0.05, size_type bits_d = 0, double _gf = 2.0) {
    ...
    private:
        ...
        create_new_level() {
            ...
            //std::cout << "level: " << max_level << "   length: " << level_size << std::endl;
            //std::cout << "M: " << M[max_level] << "  P: " << P[max_level] << std::endl;
            ...
            //std::cout << "max_h : " << max_h[max_level] << std::endl;
